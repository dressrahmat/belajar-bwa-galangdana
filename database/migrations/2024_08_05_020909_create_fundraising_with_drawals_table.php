...
return new class extends Migration
{
    ...
    {
        Schema::create('fundraising_with_drawals', function (Blueprint $table) {
            $table->id();
            $table->foreignId('fundraising_id')->on('fundraisings')->constrained()->onDelete('cascade');
            $table->foreignId('fundraiser_id')->on('fundraisers')->constrained()->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('fundraising_with_drawals');
    }
};