        ...
        <div class="flex flex-col z-30">
            <div id="content"
                ...
                <form
                    ...
                    enctype="multipart/form-data" method="POST" class="flex flex-col gap-5">
                            ...
                            <div id="accordion-faq-1" class="accordion-content open">
                                <div class="pt-3 flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-semibold text-sm">Masjid ASA Infaq</span>
                                        <input type="hidden" id="account" name="account" value="Masjid ASA Infaq">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="mr-[10px] w-6 h-6 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('../assets/images/icons/user.svg') }}"
                                    class="h-full
                                    w-full object-contain" alt="icon">
                            </div>
                            <input type="text"
