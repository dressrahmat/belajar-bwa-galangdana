        ...
        <div class="header flex flex-col bg-[#56BBC5] overflow-hidden h-[350px] relative -mb-[92px]">
            <nav class="pt-5 px-3 flex justify-between items-center relative z-20">
                <div class="flex items-center gap-[10px]">
                    <a href="{{ route('beranda') }}" class="w-10 h-10 flex shrink-0">
        ...
        <div class="flex flex-col z-30">
            ...
            @if ($fundraising->has_finished)
                <div id="status"
                    ...
                    <p class="font-semibold text-sm text-white">This fundrising has been finished</p>
                </div>
            @else
                <div id="status"
                        ...
                        @forelse ($fundraising->donaturs as $donatur)
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col gap-[2px] w-full">
                                    ...
                                    <p class="caption text-xs leading-[18px] text-[#66697A]">
                                        {{ $donatur->notes }}
                                    </p>
                                </div>
                            </div>
