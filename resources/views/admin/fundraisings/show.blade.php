            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @else
                    <div class="flex flex-row justify-between">
                        ...
                        @role('owner')
                            <form action="{{ route('admin.fundraisings_withdrawals.activate_fundraising', $fundraising) }}"
                                method="POST">
                                @csrf
                ...
                @if ($goalReached)
                    @if (!$hasRequestedWithdrawal)
                        ...
                        <form method="POST" action="{{ route('admin.fundraisings_withdrawals.store', $fundraising) }}"
                ...
                @empty
                    <p class="text-slate-500 text-sm">Belum ada yang menjadi donatur</p>
                @endforelse
